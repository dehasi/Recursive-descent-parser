...
public class FunctionTest {
    ...
    public void testFunctions() {
        assertEquals(0.8414709848078965, calculator.calculate("sin(1)"), DELTA);
        assertEquals(0.008851309290403876, calculator.calculate("sin(2 - 3 * 2 ^ 3)"), DELTA);
        assertEquals(0.49200845689934886, calculator.calculate("sin(sin(cos(1)))"), DELTA);
        assertEquals(-110, calculator.calculate("-Abs(1E+1^2 + 20/ 2)"), DELTA);
    }
